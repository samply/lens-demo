...
export const staticCatalogue: Array<Category> = [
  ...
  new Category(
      ...
      [
        ...
        // @TODO: commented out because it does not yet have a CQL mapping. Must be translated to CQL later
            new Criteria(
              ...
              {de: "Lokale Beurteilung Resttumor", en: "local assessment residual tumor"},
              "string",
          ...
          [
            ...
            new Criteria(
              ...
              [
                ...
                {    "key": "GEN",
                  "de": "Generalisierte Metastasierung",
                  "en": ""
                }
          ]
        )
    ...
    new Category( // @TODO: only one category with the following types is necessary: OP, Strahlentherapie, Chemotherapie, Immuntherapie, Hormontherapie und Knochentransplantation  XXXXXXXXXXXXXXXXX
      "therapy_of_tumor",
      "Therapie des Tumors",
      [
        new Criteria(
        ...
        new Criteria(
          "IM",
          {de: "Immunotherapie", en: ""},
          "boolean",
          ""
        ),
        new Criteria(
          "HO",
          {de: "Hormontherapie", en: ""},
          "boolean",
          ""
        ),
        new Criteria(
          "KM",
          {de: "Knochentransplantation", en: ""},
          "boolean",
          ""
        )
